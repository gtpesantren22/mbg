            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium">
                                                        <i class="fas ${statusIcon} mr-1"></i><?= date('d M Y', strtotime($data->tanggal)) ?>
                                                    </span>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium">
                                                        <i class="fas ${statusIcon} mr-1"></i><?= $data->alasan ?>
                                                    </span>
                                                </td>
                                                ...
                                                <i class="fas fa-edit"></i>
                                                    ...
                                                    <a href="<?= base_url('absensi/delIzin/' . $data->id) ?>" onclick="return confirm('Yakin akan dihapus ?')" class="text-red-600 hover:text-red-900">
                ...
                <div class="md:col-span-4">
                    <div class="bg-white shadow rounded-lg p-6">
                        <h3 class="text-lg font-semibold mb-4">Input Izin Karwayan</h3>

                        <div class="space-y-3">
                            <div id="info-input"></div>
                            <form action="<?= base_url('absensi/addIzin') ?>" method="post" class="space-y-5">
                                ...
                                <div>
                                    <label for="tanggal" class="block text-sm font-medium text-gray-700 mb-1">Tanggal izin *</label>
